  ...
  (syntax-parse stx
    [(_ tname:id rest:type-alias-rest
     ...
     #`(begin
         ...
         #,(ignore (contract-def/alias-property #'(define ctc-t #f) #'(typed rest)))
         #,(ignore (contract-def/alias-property #'(define ctc-u #f) #'(untyped rest)))
         #,(ignore (contract-def/alias-property #'(define ctc-b #f) #'(both rest)))
         #,(internal
            (syntax/loc stx
              (define-type-alias-internal tname rest rest.args
                (ctc-t ctc-u ctc-b)))))]
