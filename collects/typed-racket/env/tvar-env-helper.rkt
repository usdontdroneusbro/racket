...
;; common functionality for Delta and Theta environments

(require "../utils/utils.rkt"
         (rep type-rep)
         racket/dict)

(provide define-tvar-ids)

;; a macro to define common type variable functionality
(define-syntax-rule (define-tvar-ids
                      initial-tvar-env
                      current-tvars
                      extend-tvars extend-tvars/new
                      bound-tvar? lookup-tvar
                      extend extend/many)
  (begin
